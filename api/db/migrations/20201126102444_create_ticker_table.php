...
class CreateTickerTable extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    {
        $ticker = $this->table('ticker');
        $ticker->addColumn('name', 'string', ['limit' => 50])
              ->addColumn('description', 'string', ['limit' => 100])
              ->addColumn('type', 'enum', ['values' => ['fund', 'stock', 'dr']])
